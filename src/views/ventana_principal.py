...
"color: rgb(0, 0, 0);")
        ...
        self.horizontalLayout_7.addWidget(self.labelSistema, 0, Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)


        self.verticalLayout_2.addWidget(self.widget, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        self.previewCredencial = QWidget(self.viewCredencial)
        self.previewCredencial.setObjectName(u"previewCredencial")
        self.previewCredencial.setMinimumSize(QSize(998, 680))
        self.previewCredencial.setMaximumSize(QSize(998, 680))
        self.horizontalLayout_6 = QHBoxLayout(self.previewCredencial)
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.btnCredencial = QWidget(self.previewCredencial)
        self.btnCredencial.setObjectName(u"btnCredencial")
        self.btnCredencial.setMinimumSize(QSize(160, 662))
        self.btnCredencial.setMaximumSize(QSize(160, 662))
        ...
        self.horizontalLayout_6.addWidget(self.btnCredencial)

        self.widgetCredencial = QWidget(self.previewCredencial)
        self.widgetCredencial.setObjectName(u"widgetCredencial")
        self.widgetCredencial.setMinimumSize(QSize(780, 675))
        palette1 = QPalette()
        palette1.setBrush(QPalette.ColorGroup.Active, QPalette.ColorRole.WindowText, brush)
        palette1.setBrush(QPalette.ColorGroup.Inactive, QPalette.ColorRole.WindowText, brush)
        self.widgetCredencial.setPalette(palette1)
        self.verticalLayout_11 = QVBoxLayout(self.widgetCredencial)
        self.verticalLayout_11.setObjectName(u"verticalLayout_11")
        self.frameFrontal = QFrame(self.widgetCredencial)
        self.frameFrontal.setObjectName(u"frameFrontal")
        self.frameFrontal.setMinimumSize(QSize(500, 300))
        self.frameFrontal.setMaximumSize(QSize(500, 300))
...
"}")
        ...
        self.labelCURPCredencial.setMinimumSize(QSize(220, 31))
        self.labelCURPCredencial.setMaximumSize(QSize(220, 16777215))
        palette2 = QPalette()
        ...
        self.labelFolioCredencial.setMinimumSize(QSize(220, 31))
        self.labelFolioCredencial.setMaximumSize(QSize(220, 16777215))
        palette3 = QPalette()
        ...
        self.labelFotoCredencial.setMinimumSize(QSize(141, 151))
        self.labelFotoCredencial.setMaximumSize(QSize(141, 151))
        ...
        self.labelNombreCredencial.setMinimumSize(QSize(220, 60))
        self.labelNombreCredencial.setMaximumSize(QSize(220, 16777215))
        palette4 = QPalette()
        ...
        self.labelFondo.setEnabled(True)
        self.labelFondo.setGeometry(QRect(0, 0, 501, 301))
        sizePolicy.setHeightForWidth(self.labelFondo.sizePolicy().hasHeightForWidth())
        self.labelFondo.setSizePolicy(sizePolicy)
        self.labelFondo.setMinimumSize(QSize(501, 301))
        self.labelFondo.setMaximumSize(QSize(501, 301))
...
"")
        ...
        self.labelDomicilioCredencial.setMinimumSize(QSize(220, 51))
        self.labelDomicilioCredencial.setMaximumSize(QSize(220, 16777215))
        palette5 = QPalette()
        ...
        self.verticalLayout_11.addWidget(self.frameFrontal, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)

        self.framePosterior = QFrame(self.widgetCredencial)
        self.framePosterior.setObjectName(u"framePosterior")
        self.framePosterior.setMinimumSize(QSize(500, 300))
        self.framePosterior.setMaximumSize(QSize(500, 300))
        ...
        self.labelFondoPosterior.setGeometry(QRect(0, -4, 501, 300))
        sizePolicy4 = QSizePolicy(QSizePolicy.Policy.Maximum, QSizePolicy.Policy.Fixed)
        sizePolicy4.setHorizontalStretch(0)
        sizePolicy4.setVerticalStretch(0)
        sizePolicy4.setHeightForWidth(self.labelFondoPosterior.sizePolicy().hasHeightForWidth())
        self.labelFondoPosterior.setSizePolicy(sizePolicy4)
        self.labelFondoPosterior.setMinimumSize(QSize(501, 300))
        self.labelFondoPosterior.setMaximumSize(QSize(500, 300))
        ...
        self.labelQrWhatsapp.setMinimumSize(QSize(141, 141))
        self.labelQrWhatsapp.setMaximumSize(QSize(141, 141))
        ...
        self.labelFamC_2.setMaximumSize(QSize(191, 71))
        ...
        self.labelFirmaCredencial.setMinimumSize(QSize(161, 31))
        self.labelFirmaCredencial.setMaximumSize(QSize(161, 31))
        palette6 = QPalette()
        ...
        self.verticalLayout_11.addWidget(self.framePosterior, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)


        self.horizontalLayout_6.addWidget(self.widgetCredencial)
