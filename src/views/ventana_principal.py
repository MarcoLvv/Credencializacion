...
"}")
        ...
        self.mainWidget.setMinimumSize(QSize(1200, 731))
...
"color: rgb(0, 0, 0);")
        ...
        self.labelFamCLogo = QLabel(self.infoWidget)
        self.labelFamCLogo.setObjectName(u"labelFamCLogo")

        self.horizontalLayout_7.addWidget(self.labelFamCLogo)
        ...
        self.usersTableFrame.setMinimumSize(QSize(950, 551))
        self.usersTableFrame.setMaximumSize(QSize(950, 551))
        ...
        sizePolicy.setHeightForWidth(self.captureView.sizePolicy().hasHeightForWidth())
        self.captureView.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.actionsCaptureWidget.sizePolicy().hasHeightForWidth())
        self.actionsCaptureWidget.setSizePolicy(sizePolicy1)
        self.actionsCaptureWidget.setMinimumSize(QSize(275, 0))
        self.actionsCaptureWidget.setMaximumSize(QSize(275, 648))
        self.verticalLayout_7 = QVBoxLayout(self.actionsCaptureWidget)
        self.verticalLayout_7.setObjectName(u"verticalLayout_7")
        self.frameFotoF = QFrame(self.actionsCaptureWidget)
        ...
        self.labelPhoto = QLabel(self.widgetBtn)
        ...
        self.labelPhoto.setMinimumSize(QSize(160, 195))
        self.labelPhoto.setMaximumSize(QSize(160, 195))
        ...
        self.startPhotoBtn = QPushButton(self.widgetBtn)
        ...
        self.uploadPhotoBtn = QPushButton(self.widgetBtn)
        ...
        sizePolicy3.setHeightForWidth(self.labelSignature.sizePolicy().hasHeightForWidth())
        self.labelSignature.setSizePolicy(sizePolicy3)
        ...
        self.verticalLayout_9.addWidget(self.labelSignature)
        ...
        self.verticalLayout_9.addWidget(self.startSignatureBtn)

        self.uploadSignatureBtn = QPushButton(self.widgetBtn)
        self.uploadSignatureBtn.setObjectName(u"uploadSignatureBtn")
        self.uploadSignatureBtn.setEnabled(False)

        self.verticalLayout_9.addWidget(self.uploadSignatureBtn)


        self.verticalLayout_6.addWidget(self.widgetBtn)

        self.saveDataBtn = QPushButton(self.frameFotoF)
        ...
        self.horizontalLayout_2.addWidget(self.actionsCaptureWidget)
        ...
        self.credentialPreview.setMaximumSize(QSize(998, 680))
        ...
        self.verticalLayout_11 = QVBoxLayout(self.credentialWidget)
        self.verticalLayout_11.setObjectName(u"verticalLayout_11")
        self.frontFrameCredential = QFrame(self.credentialWidget)
        self.frontFrameCredential.setObjectName(u"frontFrameCredential")
        self.frontFrameCredential.setMinimumSize(QSize(500, 300))
        self.frontFrameCredential.setMaximumSize(QSize(500, 300))
        self.frontFrameCredential.setAutoFillBackground(False)
        self.frontFrameCredential.setStyleSheet(u"QFrame#frameFrontal {\n"
"    border-radius: 25px;\n"
"}")
        self.frontFrameCredential.setFrameShape(QFrame.Shape.StyledPanel)
        self.frontFrameCredential.setFrameShadow(QFrame.Shadow.Raised)
        self.labelCredentialCURP = QLabel(self.frontFrameCredential)
        ...
        self.labelCredentialFolio = QLabel(self.frontFrameCredential)
        ...
        self.labelCredentialFolio.setMaximumSize(QSize(220, 16777215))
        palette3 = QPalette()
        ...
        self.labelUserPhotoCredencial = QLabel(self.frontFrameCredential)
        self.labelUserPhotoCredencial.setObjectName(u"labelUserPhotoCredencial")
        self.labelUserPhotoCredencial.setGeometry(QRect(45, 100, 150, 180))
        self.labelCredentialName = QLabel(self.frontFrameCredential)
        self.labelCredentialName.setObjectName(u"labelCredentialName")
        self.labelCredentialName.setGeometry(QRect(220, 30, 220, 60))
        self.labelCredentialName.setMinimumSize(QSize(220, 60))
        self.labelCredentialName.setMaximumSize(QSize(220, 16777215))
        palette4 = QPalette()
        ...
        self.labelFrontBackgroundCredential = QLabel(self.frontFrameCredential)
        ...
        self.labelFrontBackgroundCredential.setMaximumSize(QSize(501, 301))
        self.labelFrontBackgroundCredential.setStyleSheet(u"image: url(:/layout/front.png);\n"
"")
        ...
        self.labelCredentialAddress = QLabel(self.frontFrameCredential)
        ...
        self.verticalLayout_11.addWidget(self.frontFrameCredential, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)

        self.backFrameCredential = QFrame(self.credentialWidget)
        self.backFrameCredential.setObjectName(u"backFrameCredential")
        self.backFrameCredential.setMinimumSize(QSize(500, 300))
        self.backFrameCredential.setMaximumSize(QSize(500, 300))
        self.backFrameCredential.setFrameShape(QFrame.Shape.StyledPanel)
        self.backFrameCredential.setFrameShadow(QFrame.Shadow.Raised)
        self.labelReverseBackgroundCredential = QLabel(self.backFrameCredential)
        ...
        sizePolicy4.setHeightForWidth(self.labelReverseBackgroundCredential.sizePolicy().hasHeightForWidth())
        self.labelReverseBackgroundCredential.setSizePolicy(sizePolicy4)
        ...
        self.labelQrWhatsappCredential = QLabel(self.backFrameCredential)
        ...
        self.labelCredentialFamCLogo = QLabel(self.backFrameCredential)
        ...
        self.labelSignatureCredential = QLabel(self.backFrameCredential)
        self.labelSignatureCredential.setObjectName(u"labelSignatureCredential")
        self.labelSignatureCredential.setGeometry(QRect(260, 90, 161, 31))
        self.labelSignatureCredential.setMinimumSize(QSize(161, 31))
        self.labelSignatureCredential.setMaximumSize(QSize(161, 31))
        palette6 = QPalette()
        ...
        self.verticalLayout_11.addWidget(self.backFrameCredential, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)


        self.horizontalLayout_6.addWidget(self.credentialWidget)


        self.horizontalLayout_5.addWidget(self.credentialPreview, 0, Qt.AlignmentFlag.AlignLeft)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelFamCLogo.setText(QCoreApplication.translate("MainWindow", u"LogoFamC", None))
        ...
        self.uploadSignatureBtn.setText(QCoreApplication.translate("MainWindow", u"Capturar Firma", None))
