...
"color: rgb(0, 0, 0);")
        ...
        sizePolicy.setHeightForWidth(self.frameFotoF.sizePolicy().hasHeightForWidth())
        self.frameFotoF.setSizePolicy(sizePolicy)
        self.frameFotoF.setMaximumSize(QSize(257, 16777215))
        self.frameFotoF.setFrameShape(QFrame.Shape.StyledPanel)
        self.frameFotoF.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_12 = QVBoxLayout(self.frameFotoF)
        self.verticalLayout_12.setObjectName(u"verticalLayout_12")
        self.widgetPhoto = QWidget(self.frameFotoF)
        ...
        self.verticalLayout_11 = QVBoxLayout(self.widgetPhoto)
        ...
        self.verticalLayout_11.addWidget(self.comboBoxCamera)
        ...
        self.labelPhoto.setMinimumSize(QSize(140, 160))
        self.labelPhoto.setMaximumSize(QSize(140, 160))
        self.labelPhoto.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout_11.addWidget(self.labelPhoto, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        self.verticalLayout_11.addWidget(self.startPhotoBtn)
        ...
        self.verticalLayout_11.addWidget(self.uploadPhotoBtn)


        self.verticalLayout_12.addWidget(self.widgetPhoto)

        self.widgetBtn = QWidget(self.frameFotoF)
        self.widgetBtn.setObjectName(u"widgetBtn")
        self.widgetBtn.setMinimumSize(QSize(236, 250))
        self.widgetBtn.setMaximumSize(QSize(236, 250))
        self.verticalLayout_9 = QVBoxLayout(self.widgetBtn)
        self.verticalLayout_9.setObjectName(u"verticalLayout_9")
        self.widgetSignature = QWidget(self.widgetBtn)
        self.widgetSignature.setObjectName(u"widgetSignature")
        self.verticalLayout_6 = QVBoxLayout(self.widgetSignature)
        self.verticalLayout_6.setObjectName(u"verticalLayout_6")
        self.labelSignature = QLabel(self.widgetSignature)
        ...
        self.verticalLayout_6.addWidget(self.labelSignature)

        self.startSignatureBtn = QPushButton(self.widgetSignature)
        ...
        self.verticalLayout_6.addWidget(self.startSignatureBtn)


        self.verticalLayout_9.addWidget(self.widgetSignature)


        self.verticalLayout_12.addWidget(self.widgetBtn)
        ...
        self.verticalLayout_12.addWidget(self.saveDataBtn)
        ...
        self.frontWidgetCredential.setGeometry(QRect(227, 26, 500, 300))
...
"}")
        ...
        self.backWidgetCredential.setGeometry(QRect(227, 349, 500, 300))
        ...
        sizePolicy5.setHeightForWidth(self.labelReverseBackgroundCredential.sizePolicy().hasHeightForWidth())
        self.labelReverseBackgroundCredential.setSizePolicy(sizePolicy5)
